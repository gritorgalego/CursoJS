...
function geraSenha(qtd, maiusculas, minsuculas, numeros, simbolos) {
  var senhaArray = [];
  qtd = Number(qtd);
  for (var i = 0; i < qtd; i++) {
    maiusculas && senhaArray.push(geraMaiuscula());
    minsuculas && senhaArray.push(geraMinuscula());
