...
var GeraCPF = /*#__PURE__*/function () {
  ...
  return _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var digito1 = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigitos);
      var digito2 = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigitos + digito1);
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  return _createClass(ValidaCPF, [{
    ...
    value: function geraDigito(cpfSemDigitos) {
      // Pode ser estático já que não depende de nada da classe, apenas do parâmetro passado
      var total = 0;
...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
    --primaryColor: rgb(62, 27, 203);
    --buttonColor: #007bff;
    --buttonHoverColor: #0050a8; /* Nova cor mais escura para o hover */
}
...
.cpf-gerado{
  ...
  margin-bottom: 20px;
  letter-spacing: 2px;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;IACI,gCAAgC;IAChC,sBAAsB;IACtB,2BAA2B,EAAE,sCAAsC;AACvE;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,+BAA+B;EAC/B,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,sCAAsC;AACxC;;AAEA;EACE,YAAY;EACZ,+BAA+B;EAC/B,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,0BAA0B;EAC1B,kBAAkB;EAClB,iBAAiB;EACjB,mBAAmB;EACnB,mBAAmB;AACrB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n    --primaryColor: rgb(62, 27, 203);\n    --buttonColor: #007bff;\n    --buttonHoverColor: #0050a8; /* Nova cor mais escura para o hover */\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primaryColor);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\nform input, form label, form button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\nform input:focus {\n  outline: 1px solid var(--primaryColor);\n}\n\nform button {\n  border: none;\n  background: var(--primaryColor);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  margin-top: 30px;\n}\n\nform button:hover {\n  background: var(--buttonHoverColor);\n}\n\n.container h1 {\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.cpf-gerado{\n  font-size: 2em;\n  color: var(--primaryColor);\n  text-align: center;\n  font-weight: bold;\n  margin-bottom: 20px;\n  letter-spacing: 2px;\n}"],"sourceRoot":""}]);
// Exports
